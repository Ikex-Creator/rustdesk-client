...
foreach ($required in @(
    ...
    'name: Reproducible unsigned builds one and two',
    'path: isolated-build-two',
    '-OutputRoot "$env:RUNNER_TEMP\sit-managed-build-one"',
    '-OutputRoot "$env:RUNNER_TEMP\sit-managed-build-two"',
